                ...
                <Row className="align-items-center">
                  <Col lg={6}>
                    <div className="home-content">
                      <p className="mb-0">Easy Solutions</p>
                      <img src={HomeUrl} height="15" alt="" />
                      <h1 className="home-title mt-4">Grow your  Business
                      <br /> with our Software! </h1>
                      <p className="text-muted mt-4 f-18">A&S INFOTECH is an IT Solution provider. We specialize in Multi vendor e-commerce (B2B,B2C),Software Development, Web Application, App Development, IoT, IT Consulting, Digital Marketing.</p>
